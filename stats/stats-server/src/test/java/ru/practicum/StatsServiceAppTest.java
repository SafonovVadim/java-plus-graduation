...
public class StatsServiceAppTest {
    ...
    void shouldSaveHit() {
        ...
        assertThat(saved.getFirst().getApp(), equalTo("test-app"));
        assertThat(saved.getFirst().getUri(), equalTo("/test"));
        assertThat(saved.getFirst().getIp(), equalTo("192.168.0.1"));
        assertThat(saved.getFirst().getTimestamp(), equalTo(BASE_TIME));
    }
    ...
    void shouldReturnAllHitsWhenUniqueFalse() {
        ...
        ViewStats result = stats.getFirst();
